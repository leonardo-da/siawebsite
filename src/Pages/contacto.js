          ...
          <div className="row">
            <div className="col-sm mb-4 text-center">
              <div className="my-5">
                ...
                <p>Lunes a viernes: 9:00am a 6:00pm</p>
                <p>Sabado: 9:00am a 1:00pm</p>
              </div>
              <div className="mb-4">
                <h2 className="mb-3">Teléfonos</h2>
                <div>
                <svg className="me-3" width="24px" height="24px" viewBox="0 2 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
